...
const App = () => {
    ...
    //update the setFoundCountry state so React will automatically re-render
        ...
        <div>
            ...
            <p>
                ...
                {filteredCountries.map(country => 
                    <p key={country.name.common}>{country.name.common} <button onClick={() => displayCountryData(country)}>Show</button></p>
                )}
